...
if __name__ == '__main__':
    ...
    generate_file('leads', 'leads-50', 50)
    generate_file('leads', 'leads-100', 100)

    generate_file('people', 'people-50', 50)
    generate_file('people', 'people-100', 100)

    generate_file('organizations', 'organizations-50', 50)
    generate_file('organizations', 'organizations-100', 100)

    generate_file('products', 'products-50', 50)
    generate_file('products', 'products-100', 100)

    generate_file('offers', 'offers-50', 50)
